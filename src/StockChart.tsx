...
class StockChart extends React.Component<StockChartProps> {
  ...
  public render() {
    ...
    return (
      ...
      >
        <ChartAny id={2} height={barChartHeight} origin={barChartOrigin} yExtents={this.barChartExtents}>
          <BarSeries fillStyle={this.volumeColor} yAccessor={this.volumeSeries} />
        </ChartAny>
        <ChartAny id={3} height={chartHeight} yExtents={this.candleChartExtents}>
...
export default withOHLCData()(withSize({ style: { minHeight: 300 } })(withDeviceRatio()(StockChart)));
